...
internal val WORDS_5 = listOf(
    ...
    "ACTOR", "ALARM", "ANGEL", "ANKLE", "ARENA", "ARROW", "BADGE", "BAKER",
    "BEARD", "BERRY", "BIRCH", "BLAZE", "BLOCK", "BLOOM", "BOARD", "BONUS",
    "BOOST", "BOOTH", "BRAVE", "BRIDE", "BROOM", "BRUSH", "CABIN", "CABLE",
    "CAMEL", "CANAL", "CANOE", "CARGO", "CEDAR", "CHALK", "CHARM", "CHEEK",
    "CHIME", "CIDER", "CLERK", "CLIFF", "CLIMB", "CLOCK", "COACH", "COAST",
    "COCOA", "CORAL", "COUCH", "COUNT", "COURT", "COVER", "CRAFT", "CREAM",
    "CROWN", "CURVE", "CYCLE", "DAIRY", "DAISY", "DELTA", "DEPOT", "DIARY",
    "DIGIT", "DONUT", "DOZEN", "DRIFT", "DRUMS", "EAGER", "EIGHT", "ELBOW",
    "EMBER", "FABLE", "FAIRY", "FEAST", "FENCE", "FERRY", "FEVER", "FIBER",
    "FIELD", "FINCH", "FLASH", "FLEET", "FLOAT", "FLOCK", "FLOUR", "FLUTE",
    "FOCUS", "FORGE", "FRAME", "FROST", "GIANT", "GLIDE", "GLOBE", "GLOVE",
    "GRAIN", "GRASS", "GRILL", "GROVE", "GUARD", "GUEST", "GUIDE", "HAPPY",
    "HATCH", "HAVEN", "HAZEL", "HEDGE", "HORSE", "HOTEL", "HUMOR", "IVORY",
    "JELLY", "JEWEL", "JOLLY", "JUDGE", "KAYAK", "KIOSK", "KNEEL", "LABEL",
    "LAYER", "LEVER", "LILAC", "LLAMA", "LODGE", "LOGIC", "LOYAL", "LUCKY",
    "LUNAR", "MANGO", "MAPLE", "MARCH", "MEDAL", "MELON", "METAL", "METER",
    "MINER", "MIRTH", "MODEL", "MOTOR", "MOUNT", "MOUSE", "MURAL", "NOBLE",
    "NORTH", "NOVEL", "NURSE", "NYLON", "OASIS", "OLIVE", "ONION", "OPERA",
    "ORBIT", "OTTER", "PANDA", "PASTA", "PEARL", "PEDAL", "PENNY", "PETAL",
    "PILOT", "PLAZA", "POLAR", "PORCH", "PRIZE", "PROUD", "PULSE", "PUPPY",
    "QUART", "QUILT", "RANCH", "RIDGE", "ROAST", "ROBIN", "ROCKY", "ROUND",
    "ROYAL", "RULER", "SALAD", "SCALE", "SCARF", "SCOUT", "SHELL", "SHINE",
    "SHORE", "SIREN", "SKATE", "SLICE", "SMOKE", "SOLAR", "SOUND", "SPARK",
    "SPICE", "SPIRE", "SPORT", "STAGE", "STAIR", "STAMP", "STEAM", "STEEL",
    "STRAW", "SWEET", "SWIFT", "TEACH", "TEMPO", "THEME", "TIDAL", "TOAST",
    "TOPAZ", "TORCH", "TOWEL", "TOWER", "TRACK", "TRAIL", "TREAT", "TRIBE",
    "TROUT", "TRUCK", "TRUNK", "TULIP", "TWIST", "UNITY", "URBAN", "VAPOR",
    "VAULT", "VENUE", "VIVID", "VOCAL", "WAGON", "WHEEL", "WHISK", "WINDY",
    "WOVEN", "YACHT", "YEAST", "YIELD", "ZESTY"
)
