...
object GameRegistry {
    ...
    val games: List<GameMeta> = listOf(
        ...
        GameMeta(GameId.Pool, GameCategory.Arcade, "Solo", "5 min", "Aim, shoot, and sink every ball"),
        GameMeta(GameId.Chess, GameCategory.Duel, "Solo", "15 min", "Full chess with check, mate, and a bot")
    )
