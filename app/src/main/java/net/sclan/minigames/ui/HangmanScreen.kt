...
internal val HANGMAN_WORDS = WORD_POOL + listOf(
    ...
    "HORIZON", "JOURNEY", "KINGDOM", "MOUNTAIN", "SUNSHINE",
    "TREASURE", "UMBRELLA", "VOLCANO", "WHISPER", "YOGURT", "ZEPPELIN",
    "BUTTERFLY", "CHOCOLATE", "WATERFALL", "FIREWORKS", "TELESCOPE", "MICROSCOPE",
    "SUBMARINE", "HELICOPTER", "ASTRONAUT", "DINOSAUR", "TORNADO", "HURRICANE",
    "AVALANCHE", "GLACIER", "CANYON", "LAGOON", "ORCHARD", "VINEYARD",
    "CARNIVAL", "CIRCUS", "JUGGLER", "ACROBAT", "TRAPEZE", "MAGICIAN",
    "ILLUSION", "MYSTERY", "RIDDLE", "WHISTLE", "HARMONICA", "XYLOPHONE",
    "SAXOPHONE", "ORCHESTRA", "SYMPHONY", "KEYBOARD", "COMPUTER", "INTERNET",
    "SATELLITE", "TELEPHONE", "ENVELOPE", "POSTCARD", "PASSPORT", "SUITCASE",
    "VACATION", "HOLIDAY", "BIRTHDAY", "PRESENT", "SURPRISE", "FIREPLACE",
    "BLANKET", "PILLOW", "HAMMOCK", "LIGHTHOUSE", "WINDMILL", "FOUNTAIN",
    "GAZEBO", "BALCONY", "CHIMNEY", "DOORBELL", "STAIRCASE", "BASEMENT"
)
